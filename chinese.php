...
$_LANG['clientarearegistrationperiod'] = "註冊年限";
...
$_LANG['creditcardcvvwhere'] = "在哪裏找這個?";
...
$_LANG['creditcardenterexpirydate'] = "沒輸入過期日";
$_LANG['creditcardenternewcard'] = "我要更換新的信用卡";
$_LANG['creditcardenternumber'] = "你沒有輸入卡號";
$_LANG['creditcardinvalid'] = "信用卡資訊不合規定. 請更換信用卡或與我們聯繫.";
$_LANG['creditcardnumberinvalid'] = "信用卡號有問題";
$_LANG['creditcardsecuritynotice'] = "此處所輸入的資料都將經過加密並且不會在我們系統儲存";
$_LANG['creditcarduseexisting'] = "使用之前使用過的卡片";
...
$_LANG['domaincurrentrenewaldate'] = "目前續用日期";
...
$_LANG['domaindnsrecordtype'] = "記錄形式";
...
$_LANG['domainemailforwardingforwardto'] = "轉寄送到 To";
...
$_LANG['invoiceofflinepaid'] = "我們將人工核實您提供的信用卡資料.<br />一旦信用卡授權通過，您將會接到通知.";
...
$_LANG['knowledgebaseArticleRatingThanks'] = "感謝評分";
$_LANG['language'] = "語言";
$_LANG['latefee'] = "滯納金";
...
$_LANG['findyourdomain'] = "輸入您要的網址來搜尋";
$_LANG['searchtermrequired'] = "請輸入您要的網址或者是關鍵字";
$_LANG['unabletolookup'] = "Sorry, unable to lookup the term as provided";
$_LANG['invalidchars'] = "請移除空格或是特殊字元";
...
$_LANG['domainsmoresuggestions'] = "更多推薦!";
$_LANG['domainssuggestionswarnings'] = "網域推薦有時可能無效. 推薦是即時視當時狀況決定.";
...
$_LANG['cPanel']['bandwidthUsage'] = "流量使用";
$_LANG['cPanel']['usageStatsBwLimitNear'] = "你即將達到流量上限.";
$_LANG['cPanel']['usageStatsDiskLimitNear'] = "你即將達到空間上限.";
$_LANG['cPanel']['usageUpgradeNow'] = "現在升級";
$_LANG['cPanel']['usageLastUpdated'] = "最近更新";

$_LANG['cPanel']['quickShortcuts'] = "快速連結";
$_LANG['cPanel']['emailAccounts'] = "Email 帳戶";
$_LANG['cPanel']['forwarders'] = "轉信信箱";
$_LANG['cPanel']['autoresponders'] = "Autoresponders";
$_LANG['cPanel']['fileManager'] = "文件管理";
$_LANG['cPanel']['backup'] = "Backup";
$_LANG['cPanel']['subdomains'] = "二級域名";
$_LANG['cPanel']['addonDomains'] = "Addon 網域";
$_LANG['cPanel']['cronJobs'] = "Cron Jobs";
$_LANG['cPanel']['mysqlDatabases'] = "MySQL 資料庫";
$_LANG['cPanel']['phpMyAdmin'] = "phpMyAdmin";
$_LANG['cPanel']['awstats'] = "Awstats";

$_LANG['cPanel']['createEmailAccount'] = "快速創建EMAIL信箱";
$_LANG['cPanel']['usernamePlaceholder'] = "信箱名稱";
$_LANG['cPanel']['passwordPlaceholder'] = "輸入文字與數字組合密碼";
...
$_LANG['clientAreaSecurityNoSecurityQuestions'] = "設定一個安全問題與答案可以幫助你保護你的賬戶安全.";
$_LANG['clientAreaSecuritySecurityQuestionOtherError'] = "設定一個安全問題與答案可以幫助你保護你的賬戶安全.";

$_LANG['billingAddress'] = "帳單地址";

$_LANG['noPasswordResetWhenLoggedIn'] = "登入時無法要求變更密碼. 請先登出.";

$_LANG['unableToLoadShoppingCart'] = "無法加載你的購物車. 請重試或者與我們聯繫.";

$_LANG['showMenu'] = "顯示菜單";
$_LANG['hideMenu'] = "隱藏菜單";

$_LANG['from'] = "From";
$_LANG['featuredProduct'] = "最受歡迎的";
$_LANG['shoppingCartProductPerMonth'] = "<span>:price</span>/:countmo";
$_LANG['shoppingCartProductPerYear'] = "<span>:price</span>/:countyr";

$_LANG['orderForm']['findNewDomain'] = "輸入您要的關鍵字或是域名來檢查是否可以註冊.";
$_LANG['orderForm']['transferExistingDomain'] = "轉移您現有的網域名稱到我們這保存.";
$_LANG['orderForm']['www'] = "www.";
$_LANG['orderForm']['check'] = "Check";
$_LANG['orderForm']['returnToClientArea'] = "返回到客戶中心";
$_LANG['orderForm']['checkout'] = "結算";
$_LANG['orderForm']['alreadyRegistered'] = "已經是會員?";
$_LANG['orderForm']['createAccount'] = "創建新的帳戶";
$_LANG['orderForm']['enterPersonalDetails'] = "請輸入您的個人或公司資訊.";
$_LANG['orderForm']['correctErrors'] = "請先更正以下錯誤";
$_LANG['orderForm']['existingCustomerLogin'] = "現有客戶登入";
$_LANG['orderForm']['emailAddress'] = "Email 地址";
$_LANG['orderForm']['personalInformation'] = "個人資訊";
$_LANG['orderForm']['firstName'] = "名字";
$_LANG['orderForm']['lastName'] = "姓氏";
$_LANG['orderForm']['phoneNumber'] = "電話號碼";
$_LANG['orderForm']['billingAddress'] = "本人帳務資訊";
...
$_LANG['orderForm']['state'] = "州/省";
$_LANG['orderForm']['country'] = "國家";
$_LANG['orderForm']['postcode'] = "郵政編碼";
$_LANG['orderForm']['domainAlternativeContact'] = "如有需要，你可以使用不同的聯繫資料以註冊網域名稱.";
$_LANG['orderForm']['accountSecurity'] = "帳戶安全";
$_LANG['orderForm']['mediumStrength'] = "中等強度";
$_LANG['orderForm']['paymentDetails'] = "支付細節";
$_LANG['orderForm']['preferredPaymentMethod'] = "請選擇合適您的付款方式.";
$_LANG['orderForm']['cardNumber'] = "信用卡號";
$_LANG['orderForm']['cvv'] = "CVV 驗證號碼";
$_LANG['orderForm']['additionalNotes'] = "額外備註說明";
$_LANG['orderForm']['continueToClientArea'] = "點選回到會員界面";
$_LANG['orderForm']['reviewDomainAndAddons'] = "請檢視您的選擇以及考慮是否添加附加選項.";
$_LANG['orderForm']['addToCart'] = "添加到購物車";
$_LANG['orderForm']['addedToCartRemove'] = "Added to Cart (Remove)";
$_LANG['orderForm']['configureDesiredOptions'] = "調配你要的選項並繼續結算.";
$_LANG['orderForm']['haveQuestionsContact'] = "有疑問嗎? 與我們業務單位聯繫取得協助.";
$_LANG['orderForm']['haveQuestionsClickHere'] = "點選這裏";
$_LANG['orderForm']['use'] = "使用";
$_LANG['orderForm']['check'] = "檢查";
$_LANG['orderForm']['transfer'] = "轉入";
$_LANG['orderForm']['domainAddedToCart'] = "已經添加到購物車.";
$_LANG['orderForm']['registerLongerAndSave'] = "Register for longer and save!";
$_LANG['orderForm']['tryRegisteringInstead'] = "註冊其它域名來取代.";
...
$_LANG['orderForm']['submitTicket'] = "提交一個工單";
$_LANG['orderForm']['promotionAccepted'] = "促銷代碼有效! 您的訂單總價已更新.";
...
$_LANG['orderForm']['priceCycle'] = "價格/循環";
$_LANG['orderForm']['edit'] = "編輯";
$_LANG['orderForm']['update'] = "更新";
$_LANG['orderForm']['remove'] = "移除";
$_LANG['orderForm']['applyPromoCode'] = "使用促銷代碼";
$_LANG['orderForm']['estimateTaxes'] = "估算 稅金";
$_LANG['orderForm']['removePromotionCode'] = "移除促銷代碼";
$_LANG['orderForm']['updateTotals'] = "更新 Totals";
...
$_LANG['orderForm']['includedWithPlans'] = "每個方案均包括";
$_LANG['orderForm']['whatIsIncluded'] = "包含什麼?";
$_LANG['orderForm']['errorNoProductGroup'] = "Could not load any product groups.";
$_LANG['orderForm']['errorNoProducts'] = "產品羣組目前沒有商品";
...
$_LANG['subaccountpermsproductsso'] = "執行單一登入 Single Sign-On";
...
$_LANG['errorButTryAgain'] = "有錯誤.  請重新試一次.";
$_LANG['emailSent'] = "Email 已經寄出";
$_LANG['verificationKeyExpired'] = "This email verification key has expired. Please login to request a new one.";
$_LANG['emailAddressVerified'] = "感謝你完成確認你的電子郵件地址.";
$_LANG['emailKeyExpired'] = "Email 認證過期. 請重新申請.";
$_LANG['verifyEmailAddress'] = "請檢查您的郵箱並完成EMAIL認證.";
$_LANG['resendEmail'] = "重新寄出認證信件";
...
$_LANG['oauth']['authoriseAppToAccess'] = "是否授權 :appName<br />存取您的帳戶?";
$_LANG['oauth']['willBeAbleTo'] = "This application will be able to";
$_LANG['oauth']['authorise'] = "授權";
$_LANG['oauth']['currentlyLoggedInAs'] = "目前登入的身份 :firstName :lastName";
...
$_LANG['oauth']['loginToGrantApp'] = "登入來核可 :appName<br />存取您的帳戶";
$_LANG['oauth']['redirectDescriptionOne'] = "重新導向到應用程式. 請稍等.";
...
$_LANG['downloadLoginRequiredTagline'] = "請登入來下載檔案";

$_LANG['orderForm']['year'] = "Year";
$_LANG['orderForm']['years'] = "Years";
$_LANG['orderForm']['domainOrKeyword'] = "Enter a domain or keyword";
$_LANG['orderForm']['searching'] = "搜索中";
$_LANG['orderForm']['domainIsUnavailable'] = "<strong>:domain</strong> 目前無法註冊";
$_LANG['orderForm']['add'] = "添加";
$_LANG['orderForm']['suggestedDomains'] = "推薦網域名稱";
$_LANG['orderForm']['generatingSuggestions'] = "Generating suggestions for you";
$_LANG['orderForm']['addHosting'] = "添加主機";
$_LANG['orderForm']['chooseFromRange'] = "選擇我們多種形式的主機服務";
$_LANG['orderForm']['packagesForBudget'] = "多種套餐必有符合您預算的款式";
$_LANG['orderForm']['exploreNow'] = "瞭解更多";
$_LANG['orderForm']['transferToUs'] = "轉移您的網域到我們家";
$_LANG['orderForm']['transferExtend'] = "現在轉移 將會延長網域 1 年!";
$_LANG['orderForm']['transferDomain'] = "網址轉移";
$_LANG['orderForm']['extendExclusions'] = "Excludes certain TLDs and recently renewed domains";
$_LANG['orderForm']['singleTransfer'] = "單一網域轉移";
$_LANG['orderForm']['enterDomain'] = "請輸入您的網域名稱";
$_LANG['orderForm']['authCode'] = "授權碼 Authorization Code";
...
$_LANG['orderForm']['checkingAvailability'] = "檢查是否可用";
$_LANG['orderForm']['verifyingTransferEligibility'] = "Verifying transfer eligibility";
$_LANG['orderForm']['verifyingDomain'] = "核對您的網址";
$_LANG['orderForm']['transferEligible'] = "您的網址可以轉移";
$_LANG['orderForm']['transferUnlockBeforeContinuing'] = "繼續之前請確認您的域名已經從您現有的註冊商解鎖.";
$_LANG['orderForm']['transferNotEligible'] = "不符合轉移";
$_LANG['orderForm']['transferNotRegistered'] = "你輸入的域名並未註冊.";
...
$_LANG['orderForm']['domainInvalid'] = "提供的域名不符合規範";
$_LANG['orderForm']['domainInvalidCheckEntry'] = "請檢查你輸入的並在試一次.";
$_LANG['orderForm']['domainPriceRegisterLabel'] = "繼續來註冊";
...
$_LANG['pricing']['browseExtByCategory'] = "分類瀏覽";
$_LANG['pricing']['register'] = "新註冊費";
$_LANG['pricing']['transfer'] = "轉移自他處";
$_LANG['pricing']['renewal'] = "續用費";
...
$_LANG['navStore'] = "產品/購買";
$_LANG['navBrowseProductsServices'] = "瀏覽所有";

$_LANG['navWebsiteSecurity'] = "Website & Security";
$_LANG['navMarketConnectService']['symantec'] = "SSL 證書";
$_LANG['navMarketConnectService']['weebly'] = "Website Builder";
$_LANG['navMarketConnectService']['spamexperts'] = "E-mail 信箱";

$_LANG['store']['emailServices']['title'] = "E-mail 服務";
$_LANG['store']['ssl']['title'] = "SSL 證書";
...
$_LANG['emailMarketing']['joinOurMailingList'] = "加入到我們的郵件寄送名單";
...
$_LANG['sslState']['expiryDate'] = "SSL 過期日期";
